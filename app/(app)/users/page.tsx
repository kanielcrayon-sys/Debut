...
const handleAddUser = async (e: React.FormEvent) => {
  ...
  try {
    ...
    setMessage("Erreur : " + (errorObj.message || String(err)));
  }
};
 ...
 const handleDeleteUser = async (userId: string, pseudo: string) => {
  ...
  try {
    ...
    const errorObj = err as { message?: string };
    setMessage("Erreur lors de la suppression : " + (errorObj.message || String(err)));
  }
};
...
const handleUpdateUser = async (userId: string) => {
  try {
    ...
    const errorObj = err as { message?: string };
    setMessage("Erreur lors de la modification : " + (errorObj.message || String(err)));
  }
};
